...
**Status:** design, v1.9 — 2026-06-12, revised after adversarial review + contract amendments CCR-1, CCR-2, CCR-3, CCR-5, CCR-6, CCR-7, CCR-8, CCR-9 (see Review log). Binding spec: `_FRAMEWORK_MVP_DoD.md` (DoD v3); governed by `00 - DOCTRINA.md`; parameters: `factory.config.yaml`; constraints from decision log D-0002/D-0003/D-0007/D-0009.
